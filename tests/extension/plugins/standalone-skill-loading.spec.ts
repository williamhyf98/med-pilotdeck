...
test("standalone skill precedence is project > user > builtin without legacy aliases", async () => {
    ...
    try {
        ...
        await writeSkill(join(projectRoot, ".pilotdeck", "skills", "docx"), "docx", "Project DOCX skill description.", "# Project DOCX skill");
        ...
        assert.equal(docxSkills.find((skill) => skill.name === "docx")?.path, join(projectRoot, ".pilotdeck", "skills", "docx", "SKILL.md"));
