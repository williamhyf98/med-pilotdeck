...
import { createChannelRuntimeStatusReporter, readChannelRuntimeStatusSnapshot, } from "../../src/adapters/channel/protocol/ChannelRuntimeStatus.js";
test("WeixinChannel.start returns while QR login is waiting", async (t) => {
    ...
    assert.ok(updates.some((entry) => entry.channelKey === "weixin"
