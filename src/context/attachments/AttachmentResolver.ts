...
const TEXT_EXTENSIONS = new Set([
  ".txt",
  ".md",
  // Keep .json for ordinary app JSON; medical .xml/.cda are intentionally
  // excluded so chat attachments get the same path+diagnostics path as .dcm
  // (forces MCP parse instead of inlining large CDA/XML into the prompt).
  ".json",
  ".yaml",
  ".yml",
  ".csv",
