 ...
 */
export const LANGUAGE_FOLLOW_RULES =
 ...
 */
export function buildNoteCreateJsonContract(kind: "user" | "project" | "feedback"): string {
 ...
 */
export const SHARED_FRAGMENTS: SharedPromptFragments = {
